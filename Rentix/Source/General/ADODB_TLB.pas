...
// File generated on 17-9-02 9:29:10 from Type Library described below.
...
// they can be used.                                                          
// ************************************************************************ //
// Type Lib: C:\Program Files\Common Files\System\ADO\msado26.tlb (1)
...
// *********************************************************************//
  _Record = interface(_ADO)
    ...
    procedure Set_ActiveConnection(const pvar: _Connection); safecall;
...
{$ENDIF}
  ...
  protected
    ...
    procedure _Set_ActiveConnection(const pvar: WideString);
    procedure Set_ActiveConnection(const pvar: _Connection);
    function  Get_State: ObjectStateEnum;
    function  Get_Source: OleVariant;
    procedure _Set_Source(const pvar: WideString);
    procedure Set_Source(const pvar: IDispatch);
    function  Get_Mode: ConnectModeEnum;
...
{$ENDIF}
  ...
  protected
    procedure InitServerData; override;
    procedure Set_CommandStream(const pvStream: IUnknown);
...
begin
  case DispID of
   ...
   0: if Assigned(FOnInfoMessage) then
            FOnInfoMessage(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const _Connection});
   1: if Assigned(FOnBeginTransComplete) then
            FOnBeginTransComplete(Self, Params[0] {Integer}, Params[1] {const Error}, Params[2] {var EventStatusEnum}, Params[3] {const _Connection});
   3: if Assigned(FOnCommitTransComplete) then
            FOnCommitTransComplete(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const _Connection});
   2: if Assigned(FOnRollbackTransComplete) then
            FOnRollbackTransComplete(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const _Connection});
   4: if Assigned(FOnWillExecute) then
            FOnWillExecute(Self, Params[0] {var WideString}, Params[1] {var CursorTypeEnum}, Params[2] {var LockTypeEnum}, Params[3] {var Integer}, Params[4] {var EventStatusEnum}, Params[5] {const _Command}, Params[6] {const _Recordset}, Params[7] {const _Connection});
   5: if Assigned(FOnExecuteComplete) then
            FOnExecuteComplete(Self, Params[0] {Integer}, Params[1] {const Error}, Params[2] {var EventStatusEnum}, Params[3] {const _Command}, Params[4] {const _Recordset}, Params[5] {const _Connection});
   6: if Assigned(FOnWillConnect) then
            FOnWillConnect(Self, Params[0] {var WideString}, Params[1] {var WideString}, Params[2] {var WideString}, Params[3] {var Integer}, Params[4] {var EventStatusEnum}, Params[5] {const _Connection});
   7: if Assigned(FOnConnectComplete) then
            FOnConnectComplete(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const _Connection});
   8: if Assigned(FOnDisconnect) then
            FOnDisconnect(Self, Params[0] {var EventStatusEnum}, Params[1] {const _Connection});
  end; {case DispID}
end;

function  TConnection.Get_ConnectionString: WideString;
begin
  Result := DefaultInterface.Get_ConnectionString;
end;

procedure TConnection.Set_ConnectionString(const pbstr: WideString);
begin
  DefaultInterface.Set_ConnectionString(pbstr);
end;

function  TConnection.Get_CommandTimeout: Integer;
begin
  Result := DefaultInterface.Get_CommandTimeout;
end;
...
begin
  Result := DefaultInterface.Get_ConnectionTimeout;
end;
...
begin
  Result := DefaultInterface.Get_DefaultDatabase;
end;

procedure TConnection.Set_DefaultDatabase(const pbstr: WideString);
begin
  DefaultInterface.Set_DefaultDatabase(pbstr);
end;

function  TConnection.Get_IsolationLevel: IsolationLevelEnum;
begin
  Result := DefaultInterface.Get_IsolationLevel;
end;
...
begin
  Result := DefaultInterface.Get_CursorLocation;
end;
...
begin
  Result := DefaultInterface.Get_Provider;
end;

procedure TConnection.Set_Provider(const pbstr: WideString);
begin
  DefaultInterface.Set_Provider(pbstr);
end;
...
procedure TRecord._Set_ActiveConnection(const pvar: WideString);
begin
  DefaultInterface._Set_ActiveConnection(pvar);
end;

procedure TRecord.Set_ActiveConnection(const pvar: _Connection);
begin
  DefaultInterface.Set_ActiveConnection(pvar);
end;
...
begin
  Result := DefaultInterface.Get_Source;
end;

procedure TRecord._Set_Source(const pvar: WideString);
begin
  DefaultInterface._Set_Source(pvar);
end;

procedure TRecord.Set_Source(const pvar: IDispatch);
begin
  DefaultInterface.Set_Source(pvar);
end;
...
begin
  Result := DefaultInterface.Get_ParentURL;
end;
...
begin
  Result := DefaultInterface.Get_RecordType;
end;
...
procedure TRecordProperties._Set_ActiveConnection(const pvar: WideString);
begin
  DefaultInterface._Set_ActiveConnection(pvar);
end;

procedure TRecordProperties.Set_ActiveConnection(const pvar: _Connection);
begin
  DefaultInterface.Set_ActiveConnection(pvar);
end;
...
procedure TRecordProperties._Set_Source(const pvar: WideString);
begin
  DefaultInterface._Set_Source(pvar);
end;

procedure TRecordProperties.Set_Source(const pvar: IDispatch);
begin
  DefaultInterface.Set_Source(pvar);
end;
...
begin
  Result := DefaultInterface.Get_EOS;
end;
...
begin
  Result := DefaultInterface.Get_LineSeparator;
end;
...
begin
  DefaultInterface.Set_Charset(pbstrCharset);
end;
...
procedure TCommand.Set_CommandStream(const pvStream: IUnknown);
begin
  DefaultInterface.Set_CommandStream(pvStream);
end;

function  TCommand.Get_CommandStream: OleVariant;
begin
  Result := DefaultInterface.Get_CommandStream;
end;

procedure TCommand.Set_Dialect(const pbstrDialect: WideString);
begin
  DefaultInterface.Set_Dialect(pbstrDialect);
end;

function  TCommand.Get_Dialect: WideString;
begin
  Result := DefaultInterface.Get_Dialect;
end;
...
begin
  Result := DefaultInterface.Get_NamedParameters;
end;
...
procedure TCommandProperties.Set_CommandStream(const pvStream: IUnknown);
begin
  DefaultInterface.Set_CommandStream(pvStream);
end;
...
begin
  case DispID of
   ...
   9: if Assigned(FOnWillChangeField) then
            FOnWillChangeField(Self, Params[0] {Integer}, Params[1] {OleVariant}, Params[2] {var EventStatusEnum}, Params[3] {const _Recordset});
   10: if Assigned(FOnFieldChangeComplete) then
            FOnFieldChangeComplete(Self, Params[0] {Integer}, Params[1] {OleVariant}, Params[2] {const Error}, Params[3] {var EventStatusEnum}, Params[4] {const _Recordset});
   11: if Assigned(FOnWillChangeRecord) then
            FOnWillChangeRecord(Self, Params[0] {EventReasonEnum}, Params[1] {Integer}, Params[2] {var EventStatusEnum}, Params[3] {const _Recordset});
   12: if Assigned(FOnRecordChangeComplete) then
            FOnRecordChangeComplete(Self, Params[0] {EventReasonEnum}, Params[1] {Integer}, Params[2] {const Error}, Params[3] {var EventStatusEnum}, Params[4] {const _Recordset});
   13: if Assigned(FOnWillChangeRecordset) then
            FOnWillChangeRecordset(Self, Params[0] {EventReasonEnum}, Params[1] {var EventStatusEnum}, Params[2] {const _Recordset});
   14: if Assigned(FOnRecordsetChangeComplete) then
            FOnRecordsetChangeComplete(Self, Params[0] {EventReasonEnum}, Params[1] {const Error}, Params[2] {var EventStatusEnum}, Params[3] {const _Recordset});
   15: if Assigned(FOnWillMove) then
            FOnWillMove(Self, Params[0] {EventReasonEnum}, Params[1] {var EventStatusEnum}, Params[2] {const _Recordset});
   16: if Assigned(FOnMoveComplete) then
            FOnMoveComplete(Self, Params[0] {EventReasonEnum}, Params[1] {const Error}, Params[2] {var EventStatusEnum}, Params[3] {const _Recordset});
   17: if Assigned(FOnEndOfRecordset) then
            FOnEndOfRecordset(Self, Params[0] {var WordBool}, Params[1] {var EventStatusEnum}, Params[2] {const _Recordset});
   18: if Assigned(FOnFetchProgress) then
            FOnFetchProgress(Self, Params[0] {Integer}, Params[1] {Integer}, Params[2] {var EventStatusEnum}, Params[3] {const _Recordset});
   19: if Assigned(FOnFetchComplete) then
            FOnFetchComplete(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const _Recordset});
  end; {case DispID}
end;
...
begin
  Result := DefaultInterface.Get_Direction;
end;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TConnection, TRecord, TStream, TCommand, 
